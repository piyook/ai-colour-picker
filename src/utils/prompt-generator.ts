...
export const promptGenerator = ({
    userQuestion,
    numberOfColours,
}: PromptProperties) => `Return only an array of a complemetary palette of ${numberOfColours} colours as hex values in json format inspired by ${userQuestion}, including colour, hex, contrastingColourHex 
